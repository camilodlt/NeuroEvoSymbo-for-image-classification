...
def save_metrics_to_csv(filename, epoch, loss, val_loss, accuracy, val_accuracy, balanced_accuracy, val_balanced_accuracy):
    ...
    with open(filename, mode="a", newline="") as file:
        ...
        if not file_exists:
            writer.writerow(["epoch", "loss", "val_loss", "accuracy", "val_accuracy", "balanced_accuracy", "val_balanced_accuracy"])
...
def save_checkpoint(
    ...
    accuracy,
    val_accuracy,
    base_filename=Path("DLmodels/checkpoint"),
):
    checkpoint = {
    ...
    filename = base_filename / f"{str(epoch)}.pth"
