#!/usr/bin/env python3
"""Compose the LLM grading prompt and save OpenAI's JSON response."""
...
def main() -> None:
    """Compose the prompt, call OpenAI, and save validated JSON output."""
    args = parse_args()
    ...
    if args.method == "bigram" and args.library_id is None:
        ...
        for library_id in [1, 2, 3, 4]:
            ...
            print(prompt)
            print("===== PROMPT END =====")
            raw_text = call_openai(prompt, args.model, api_key)
